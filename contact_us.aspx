<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact_us.aspx.cs" Inherits="kartar_enterprises_and_solutions.contact" %>
...
<head>
	...
	<meta name="keywords" content="Kartar e Solutions in India Delhi, food items in Delhi, home products in India Delhi, www.kartaresolutions.co.in " />
	<script>
...
<body>
	...
	<div class="header-bot">
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1 class="text-left">
					<a href="home.aspx">&nbsp;</a><asp:Image ID="Image1" runat="server" Height="83px" ImageUrl="~/img/logo1.png" Width="354px" />
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">For Any Query</h3>
			<!-- //tittle heading -->
			<!-- contact -->
				...
				<div class="contact-agileinfo">
					...
					<div class="contact-right wthree">
						<div class="col-xs-7 contact-text w3-agileits">
							<h4>CONTACT US :</h4>
							<p>
								<i class="fa fa-map-marker"></i> LG 42,43, Lusa Tower, Azadpur, Delhi 110033</li></p>
							<p>
								<i class="fa fa-phone"></i> Telephone : +011 40450565</p>
							<p>
								<i class="fa fa-fax"></i> Mobile : +011 40450564</p>
							<p>
