<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about_us.aspx.cs" Inherits="kartar_enterprises_and_solutions.about_us" %>

<!DOCTYPE html>
<html lang="zxx">

<head>
	<title>Kartar Enterprises &Aacute; Solutions | Home :: KartareSolutions</title>
	<!--/tags -->
...
<body>
	...
	<div class="header-most-top">
		<p>Kartar Enterprises & Solutions Offer You On Grocery Products and Top Deals & Discounts</p>
	</div>
	<!-- //top-header -->
	<!-- header-bot-->
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1 class="text-left">
						...
						<a href="index.aspx">&nbsp;</a><asp:Image ID="Image1" runat="server" Height="83px" ImageUrl="~/img/logo1.png" Width="354px" />
			...
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> +011 40450564
					</li>
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li>
									<a class="nav-stylehead" href="index.aspx">Home
										<span class="sr-only">(current)</span>
									</a>
								</li>
								<li class="active">
									<a class="nav-stylehead" href="about_us.aspx">About Us</a>
								</li>
								<li class="dropdown">
								...
								<li class="">
									<a class="nav-stylehead" href="contact_us.aspx">Contact Us</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="welcome">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Welcome to our WebSite
			...
			<table class="nav-justified">
                <tr>
                    ...
                    <td class="text-center">
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/img/about_image.png" Width="300px" />
                        <br />
                        <br />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
				<p class="text-left"><strong>Kartar Enterprises & Solutions is one of the growing company in the field of E-commerce. 
                    Shree Gurudeo Singh, CEO and Founder of Kartar Enterprises & Solutions and also a retire Sub Inspector of Police.
                    He achieved many awards and achievements in our carrier.
                    Now decided to create a bridge between the Customer to Customer (B2B) and made the concept in the form of Kartar Enterprises & Solutions, He have around 48+ years of professional experience in the field of international taxation, ecommerce, finance and investments. 
                    Kartar Enterprises & Solutions a customer based model wherein we begin with understanding the customer’s requirement. We, then advise the most suitable product in the market at the best rates. </strong> </p>
                        <p class="text-left">&nbsp;</p>
				<p class="text-left"><strong>We also offer customized lending solutions catering to customer’s specific requirements. </strong> </p>
			        </td>
                </tr>
                </table>
	...
	<div class="about">
		<div class="container">
			...
			<!-- //tittle heading -->
			<div class="about-tp">
				<div class="col-md-4 about-agileits-w3layouts-left">
					
					<img src="img/logo1.png" alt="" >
					</div>
					<h4> Kartar Enterprises & Solutions</h4>
				<p>The E-commerce marketplace with over 1 million Products</p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					...
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<i class="fa fa-map-marker"></i> LG 42,43, Lusa Tower, Azadpur, Delhi 110033</li>
							<li>
								<i class="fa fa-mobile"></i> +011 40450564 </li>
							<li>
								<i class="fa fa-phone"></i> +011 40450565 </li>
							<li>
								<i class="fa fa-envelope-o"></i>
								<a href="mailto:info.kartaresolutions@gmail.com"> info.kartaresolutions@gmail.com</a>
							</li>
						</ul>
					</div>
				</div>
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2018 Kartar Enterprises and Solutions. All rights reserved | Design by
				<a href="http://alchemysofttech.com"> Alchemy Software Technologies.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
