<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="kartar_enterprises_and_solutions.index" %>
...
<body>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="contact_us.aspx">Contact Us
									</a>
								</li>
							</ul>
						</div>
	...
	<footer>
		<div class="container">
			...
			<p class="footer-main">
				<span>"Kartar Enterprises & Solutions"</span> This is one place where you can find your product and place order, we have wide range of home food products</p>
			<!-- //footer first section -->
